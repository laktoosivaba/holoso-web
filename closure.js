// Source-closure for in-browser Yosys: given the generated top module and the support library,
...
// modules the design never uses -- and any parse quirk in an unused module (e.g. a real-valued helper Yosys
...
// Node tests. Verilog has no nested modules: a module spans `module <name>` .. `endmodule`.
...
// topName: the generated module's name; designV: its source; library: { filename: source } -- in practice the
// single self-contained holoso_support.v. Returns the sorted list of library filenames to read and the set of
