// Vendored from nanotar (https://github.com/unjs/nanotar) — MIT License.
// Copyright (c) Pooya Parsa and nanotar contributors. Bundled ESM build; holoso-web uses createTarGzip
// to package the emitted files for the Output "Bundle" download.
